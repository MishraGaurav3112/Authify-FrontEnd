...
//
//        }catch (e) {
//            toast.error("Failed to verify OTp . Pls Try Again")
//        }finally {
//            setLoading(false);
//
//        }
...
//
//     return (
//     <div className="email-verify-container d-flex align-items-center vh-100 position-relative justify-content-center"
...
//             </div>
//
//             <button className="btn btn-primary w-100 fw-semibold " disabled={loading} onClick={hanldeVerify}>
...
function EmailVerify() {
    ...
    return (
        <div
            className="email-verify-container d-flex align-items-center vh-100 position-relative justify-content-center"
            style={{ background: "linear-gradient(90deg,#6a5af9, #8268f9)", borderRadius: "none" }}
        >
            <Link
                to="/"
